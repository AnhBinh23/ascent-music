        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-1">
            ...
            <input type="email" value={email} onChange={e => setEmail(e.target.value)}
              placeholder="VD: TenHV2010@ascentmusic.vn"
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-xs text-gray-400">Học viên sẽ đổi sau khi đăng nhập lần đầu</p>
          </div>
        </div>
...
const StudentDetail = () => {
  ...
  useEffect(() => {
    studentService.getById(id)
      ...
      .catch(() => toast.error('Không tải được thông tin học viên'))
