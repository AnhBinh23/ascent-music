...
const TEACHERS = [
  { id: 'GV001', name: 'Nguyễn Thị Mai',  instrument: 'Piano',      salaryPerSession: 200000, sessions: 22, bonus: 0 },
  { id: 'GV002', name: 'Trần Văn Hùng',   instrument: 'Guitar',     salaryPerSession: 180000, sessions: 18, bonus: 0 },
  { id: 'GV003', name: 'Lê Thị Hoa',      instrument: 'Violin',     salaryPerSession: 220000, sessions: 20, bonus: 500000 },
  { id: 'GV004', name: 'Phạm Minh Tuấn',  instrument: 'Thanh nhạc', salaryPerSession: 190000, sessions: 16, bonus: 0 },
];
...
const SalaryManage = () => {
  ...
  const getSalary = (t) => {
    const base  = t.salaryPerSession * t.sessions;
    const bonus = Number(bonuses[t.id] || t.bonus);
    return base + bonus;
  };
          ...
          <tbody>
            ${TEACHERS.map((t, i) => `
              <tr>
                ...
                <td>${t.instrument}</td>
                <td>${t.sessions}</td>
                <td>${t.salaryPerSession.toLocaleString('vi-VN')}đ</td>
                <td>${(Number(bonuses[t.id]||t.bonus)).toLocaleString('vi-VN')}đ</td>
  ...
  return (
    <MainLayout title="Quản lý lương giáo viên">
      ...
      <div className="grid grid-cols-3 gap-4 mb-5">
        ...
        <div className="card text-center">
          <p className="text-2xl font-bold text-green-600">{Object.keys(paid).length}/{TEACHERS.length}</p>
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-sm">
                    <div className="p-2 bg-gray-50 rounded-xl text-center">
                      ...
                      <p className="font-bold text-gray-800">{t.sessions}</p>
                    </div>
                    <div className="p-2 bg-gray-50 rounded-xl text-center">
                      <p className="text-xs text-gray-500">Đơn giá/buổi</p>
                      <p className="font-bold text-gray-800">{t.salaryPerSession.toLocaleString('vi-VN')}đ</p>
                    </div>
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    ...
                    <input type="number" value={bonuses[t.id] ?? t.bonus}
